...
def test_ds(get_ll: LinkedList) -> None:
    assert set(["append", "pop", "prepend", "get", "set_value", "remove"]).issubset(
        get_ll.ds_func
    )


def test_constructor(get_ll: LinkedList) -> None:
...
def test_reverse(get_ll3: LinkedList) -> None:
